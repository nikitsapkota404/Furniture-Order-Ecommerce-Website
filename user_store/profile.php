...
<li class="nav-item bg-info">
        ...
        <?php
                    ...
                    $user_image_query = "SELECT user_image FROM user_table WHERE user_name='$user_name'";
                    $user_image_result = mysqli_query($con, $user_image_query);
                    $row_image = mysqli_fetch_assoc($user_image_result);
                    $user_image = $row_image['user_image'];

                    if ($user_image) {
                        echo "<li class='nav-item'>
                                <img src='./user_img/$user_image' class='profile_img my-4' alt=''>
                            </li>";
                    }
                    ?>
